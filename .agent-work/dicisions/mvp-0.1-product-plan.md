...
- 文档面向没有技术背景的初学者，使用朴实、温暖、亲和的语言，像耐心带着八岁孩子完成操作：先解释日常含义，再引入术语；按实际操作顺序说明原因、步骤和结果；不为追求短句而省略读者必须知道的前提、边界或下一步。中文使用自然的高语境表达；英文同样友好、具体、直接，采用低语境组织而不逐字翻译中文语序。两种语言传递相同事实，但根据各自语言习惯独立组织句子。
